    ...
    <div className="Experiencias">
      <ul>
        <li>
          ...
          <br />
          Suporte técnico em sistemas comerciais;
          Atendimento presencial e por telefone;
          Configuração de impressoras, etiquetadoras, busca preços, leitores e demais equipamentos;
          Conhecimento tributário e emissão de NFe, NFCe, MDFe, CTe;
          Design;
          Marketing;
          Social Media;
          Análise em banco de dados SQL;
          Conhecimento em HTML, CSS, JavaScript, React, Node;
        ...
        <li>
          ...
          Atendimento presencial e por telefone;
          Configuração de roteadores repetidores e demais equipamentos de rede;
          Sistema RouterOS;
          Manutenção e montagem de Racks;
          Manutenção e suporte de TI em computadores e redes internas da empresa;
          Atendimento ao cliente;
        ...
        <li>
          ...
          Ativação de Internet via rádio;
          Análise de upgrades e montagem de PC 's;
          Manutenção eletrônica;
          Manutenção em Nobreaks;
          Atendimento a Empresas;
          Mikrotik;
